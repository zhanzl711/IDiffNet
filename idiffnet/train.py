...
def start(conf, data, model, evaluate):
    ...
    for epoch in range(1, conf.epochs+1):
        ...
        log.record('Evaluate cost:%.4fs, hr5:%.4f, hr10:%.4f, hr15:%.4f, ndcg5:%.4f, ndcg10:%.4f, ndcg15:%.4f' %
                   ((tt3-tt2), hr5, hr10, hr15, ndcg5, ndcg10, ndcg15))
