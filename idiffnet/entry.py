...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_name', default='yelp', nargs='?', help='data name')
    parser.add_argument('--model_name', default='idiffnet', nargs='?', help='model name')
    parser.add_argument('--gpu', default='0', nargs='?', help='available gpu id')
